// flow-typed signature: f1869d161f07c5988add5560ae4c20bc
// flow-typed version: <<STUB>>/tinycolor2_v^1.4.1/flow_v0.81.0
...
declare module 'tinycolor2' {
  ...
  declare interface PRGB {
    r: string;
    g: string;
    b: string;
  }

  declare interface PRGBA extends PRGB, Alpha {
  }
  ...
  declare interface RGBA extends RGB, Alpha {
  }
  ...
  declare interface HSLA extends HSL, Alpha {
  }
  ...
  declare type ColorInputWithoutTinyColor = string | PRGB | PRGBA | RGB | RGBA | HSL | HSLA | HSV | HSVA;

  declare type ColorInput = ColorInputWithoutTinyColor | TinyColor;
  ...
  declare interface WCAG2Options {
    level?: "AA" | "AAA";
    size?: "large" | "small";
  }

  declare interface MostReadableArgs extends WCAG2Options {
  ...
  declare interface Constructor {
     ...
     */
    new(color?: ColorInput, opts?: ConstructorOptions): TinyColor;

    (color?: ColorInput, opts?: ConstructorOptions): TinyColor;
     ...
     */
    fromRatio(ratio?: ColorInputWithoutTinyColor): TinyColor;
     ...
     */
    mostReadable(baseColor: ColorInput, colorList: ColorInput[], args?: MostReadableArgs): TinyColor;
  ...
  declare export interface TinyColor {
    /**
  ...
  declare export default Constructor;
}
